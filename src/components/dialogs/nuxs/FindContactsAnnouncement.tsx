        ...
        <View style={[a.align_center, a.pt_3xl]}>
          ...
          <View style={[a.w_full, a.pt_sm, a.px_5xl, a.pb_4xl]}>
            <Image
              ...
              alt={_(
                msg`An illustration depicting user avatars flowing from a contact book into the Chai app`,
              )}
            />
          </View>
        </View>
        <View style={[a.align_center, a.px_xl, a.gap_5xl]}>
          <View style={[a.gap_sm, a.align_center]}>
            ...
            <Text
              ...
              <Trans>
                Chai is more fun with friends! Import your contacts to see who’s
                already here.
              </Trans>
            </Text>
          </View>
